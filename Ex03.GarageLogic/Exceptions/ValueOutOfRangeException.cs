...
namespace Ex03.GarageLogic
{
    public class ValueOutOfRangeException : Exception
    {
        ...
        public ValueOutOfRangeException(string i_Concept, float i_ReceivedIndex, float i_MinValue, float i_MaxValue) :
        ...
        public ValueOutOfRangeException(float i_ReceivedIndex, float i_MinValue, float i_MaxValue) :
